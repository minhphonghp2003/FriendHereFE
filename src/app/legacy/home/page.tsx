        ...
        >
          ...
          <div className="absolute top-4 right-2 z-40 flex flex-col items-end gap-2">
            ...
            <button
              ...
              className="text-primary flex items-center gap-1.5 rounded-full border-0 bg-white px-3 py-1.5 text-xs font-semibold shadow-md transition-colors hover:bg-zinc-50"
            >
      ...
      <div className="relative" style={{ width: "100%", height: "calc(100dvh - 4rem)" }}>
        <div className="absolute top-4 right-2 z-40 flex flex-col items-end gap-2">
          ...
          <button
            onClick={handleReload}
            disabled={reloading}
            className="bg-primary hover:bg-primary/90 flex items-center gap-1.5 rounded-full border-0 px-3 py-1.5 text-xs font-semibold text-white shadow-md transition-colors disabled:opacity-50"
          >
            {reloading ? (
              <Loader2 className="h-3.5 w-3.5 animate-spin" />
            ) : (
