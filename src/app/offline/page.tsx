...
export default function OfflinePage() {
  return (
    <div className="safe-top safe-bottom bg-background flex min-h-dvh flex-col items-center justify-center px-6 py-10">
      <div className="w-full max-w-sm space-y-6 text-center">
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground text-sm">
            You can still browse cached conversations, moments, and timelines. Actions you take will
            be queued and synced automatically when you&apos;re back online.
          </p>
        </div>
