  ...
  return (
    <div className="flex min-h-dvh flex-col items-center justify-center gap-8 p-8">
      <div className="text-center">
        ...
        {user && <p className="mt-1 text-sm text-zinc-400">Welcome back, {user.name}</p>}
      </div>

      <div className="grid w-full max-w-3xl gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <Card className="transition-colors hover:border-blue-500">
          <CardHeader>
        ...
        <Card className="transition-colors hover:border-green-500">
          <CardHeader>
        ...
        <Card className="transition-colors hover:border-purple-500">
          <CardHeader>
      ...
      <p className="text-xs text-zinc-400">Theme: {appState.locale} | Status: Connected</p>
    </div>
  );
};
